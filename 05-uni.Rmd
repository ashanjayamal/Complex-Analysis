...
**$S$ is not a vector space.** The sum of two functions in $S$ need not be univalent — e.g. $\dfrac{z}{1-z} + \dfrac{z}{1+iz}$ has a critical point inside $\mathbb D$. This is a good reminder that $S$ is a *geometric* class (defined by injectivity), not an algebraic one.

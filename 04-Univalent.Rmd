...
- A **Simple Closed Curve (Jordan Curve)** is a closed curve without self-intersections.
- The interior of a Jordan curve is called a **Jordan domain**.
```
...
## Positive Harmonic Functions (opening)

Sets up motivation for Chapter 2's subclasses of $S$ defined by $\mathrm{Re}\,p(z)>0$, $p(0)=1$  leading into the **Herglotz representation theorem** (1911): every positive harmonic function normalized at $0$ is the Poisson integral of a positive measure. The file cuts off right as this is introduced.

...
```{tikz, comprehensive-curves-grid, fig.cap = "Comprehensive comparison of curves, arcs, and non-arc structures in the complex plane.", fig.align = "center", echo = FALSE}
...
% ====================================================
  ...
  \end{scope}
```{r, animated-arc, message=FALSE, warning=FALSE, eval=knitr::is_html_output(), fig.align="center"}
library(plotly)

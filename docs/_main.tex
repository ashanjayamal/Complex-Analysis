...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-5}{}\label{exr:unnamed-chunk-5}Assume that for all \(p \in R_1\) there is a chart \((U,\phi)\) such that \(p \in U\) and a chart \((V,\psi)\) such that \(f(p) \in V\), so that \(\psi \circ f \circ \phi^{-1}\) is holomorphic (in the standard sense, as a complex analytic function on an open subset of the plane). Show that \(f\) is holomorphic.
\end{exercise}
...
\begin{exercise}
\protect\hypertarget{exr:unnamed-chunk-8}{}\label{exr:unnamed-chunk-8}Show that \(\widehat{\mathbb{C}}\) is compact.
\end{exercise}
